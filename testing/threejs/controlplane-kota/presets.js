...
window.PRESETS = [
  ...
  // ---- 3: ControlPlane sage / lime - James's tuned JSON (2026-09-09, revised: minty lights, cooler fade).
  {
    ...
    "lights": {
      ...
      "Lavender pool":  { "hex": "9cf7d9", "intensity": 15.7, "opacity": 0.51 },
      "White overhead": { "hex": "cef79e", "intensity": 7,    "opacity": 1 },
      "Warm bounce":    { "hex": "9cf7d0", "intensity": 21.4, "opacity": 1 },
      "Aqua backdrop":  { "hex": "8ee1cc", "intensity": 5.8,  "opacity": 0.54 },
      "Warm side band": { "hex": "61ff7b", "intensity": 24,   "opacity": 1 }
    },
    "sun": { "key": { "color": "cef79e", "intensity": 1.2 }, "rim": { "color": "a2bfa7", "intensity": 2.54 } },
