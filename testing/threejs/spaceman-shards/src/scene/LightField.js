...
const BARS = [
  // Bar HDR levels are deliberately moderate: auto-exposure holds the
  // average brightness, so hotter emitters only buy blown-out white washes
  // when a near-camera face catches one square-on.
  // Primary long white blade — the main sweeping band.
  { size: [110, 9], color: [3.6, 3.65, 3.75], radius: 26, speed: 0.045,  tilt: 0.45, phase: 0.0, roll: 0.05 },
  // Secondary white blade on a counter-rotating, steeper orbit.
  { size: [70, 4],  color: [2.6, 2.65, 2.75], radius: 30, speed: -0.032, tilt: 1.15, phase: 2.1, roll: -0.04 },
  // Wide neutral wash.
  { size: [80, 14], color: [2.0, 2.03, 2.06], radius: 34, speed: 0.021,  tilt: 0.85, phase: 4.2, roll: 0.03 },
  // Short intense sliver — sharp glints on bevels.
  { size: [46, 2.5], color: [4.4, 4.4, 4.5],  radius: 22, speed: 0.052,  tilt: 1.5,  phase: 1.2, roll: 0.07 },
  // Third white blade so at least two sweeps are always in view.
  { size: [85, 6],  color: [2.8, 2.85, 2.95], radius: 28, speed: 0.027,  tilt: 2.3,  phase: 5.6, roll: -0.03 },
  ...
  { size: [95, 7],  color: [3.1, 3.15, 3.25], radius: 29, speed: -0.019, tilt: 2.85, phase: 1.7, roll: 0.04 },
  ...
  { size: [44, 24], color: [0.68, 0.68, 0.68], radius: 42, speed: 0.012, tilt: 0.7,  phase: 3.3, roll: 0.0, spectral: true },
  { size: [34, 17], color: [0.55, 0.55, 0.55], radius: 38, speed: -0.016, tilt: 1.4, phase: 0.6, roll: 0.02, spectral: true },
